...
<head>
    ...
    <title>@yield('title','nosidebar')</title>
    <!-- font icons -->
    ...
    <div class="container">
        <section>
            <div class="feature-posts">
                ...
                <a href="single-post.html" class="feature-post-item">
                    <img src="{{asset('front')}}/assets/imgs/img-1.jpg" class="w-100" alt="">
                    <div class="feature-post-caption">Incidunt Quaerat</div>
                </a>
                <a href="single-post.html" class="feature-post-item">
                    <img src="{{asset('front')}}/assets/imgs/img-2.jpg" class="w-100" alt="">
                    <div class="feature-post-caption">Culpa Ducimus</div>
                </a>
                <a href="single-post.html" class="feature-post-item">
                    <img src="{{asset('front')}}/assets/imgs/img-3.jpg" class="w-100" alt="">
                    <div class="feature-post-caption">Temporibus Simile</div>
                </a>
                <a href="single-post.html" class="feature-post-item">
                    <img src="{{asset('front')}}/assets/imgs/img-4.jpg" class="w-100" alt="">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="blog-media">
                            <img src="{{asset('front')}}/assets/imgs/blog-6.jpg" alt="" class="w-100">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card text-center mb-5">
                            <div class="card-header p-0">
                                <div class="blog-media">
                                    <img src="{{asset('front')}}/assets/imgs/blog-2.jpg" alt="" class="w-100">
                    ...
                    <div class="col-lg-6">
                        <div class="card text-center mb-5">
                            <div class="card-header p-0">
                                <div class="blog-media">
                                    <img src="{{asset('front')}}/assets/imgs/blog-3.jpg" alt="" class="w-100">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card text-center mb-5">
                            <div class="card-header p-0">
                                <div class="blog-media">
                                    <img src="{{asset('front')}}/assets/imgs/blog-4.jpg" alt="" class="w-100">
                    ...
                    <div class="col-lg-6">
                        <div class="card text-center mb-5">
                            <div class="card-header p-0">
                                <div class="blog-media">
                                    <img src="{{asset('front')}}/assets/imgs/blog-5.jpg" alt="" class="w-100">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card text-center mb-5">
                            <div class="card-header p-0">
                                <div class="blog-media">
                                    <img src="{{asset('front')}}/assets/imgs/blog-1.jpg" alt="" class="w-100">
                    ...
                    <div class="col-lg-6">
                        <div class="card text-center mb-5">
                            <div class="card-header p-0">
                                <div class="blog-media">
                                    <img src="{{asset('front')}}/assets/imgs/blog-7.jpg" alt="" class="w-100">
