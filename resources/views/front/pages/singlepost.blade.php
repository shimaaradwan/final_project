...
<head>
    ...
    <title>@yield('title','singlepost')</title>
    <!-- font icons -->
            ...
            <div class="page-content">
                <div class="card">
                    ...
                    <div class="card-footer">
                        ...
                        <hr>
                        <div class="media">
                            <img src="{{asset('front')}}/assets/imgs/avatar-1.jpg" class="mr-3 thumb-sm rounded-circle" alt="...">
                            <div class="media-body">
                                ...
                                <div class="media mt-5">
                                    <a class="mr-3" href="#">
                                    <img src="{{asset('front')}}/assets/imgs/avatar.jpg" class="thumb-sm rounded-circle" alt="...">
                                    </a>
                        ...
                        <div class="media mt-5">
                            <img src="{{asset('front')}}/assets/imgs/avatar-2.jpg" class="mr-3 thumb-sm rounded-circle" alt="...">
                            <div class="media-body">
                        ...
                        <div class="media mt-4">
                            <img src="{{asset('front')}}/assets/imgs/avatar-3.jpg" class="mr-3 thumb-sm rounded-circle" alt="...">
                            <div class="media-body">
